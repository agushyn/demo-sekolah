...
export default function StaffCreate({ suggestedSortOrder = 1 }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post('/admin/guru-staff');
    };

    return (
        <AdminLayout title="Tambah Guru / Staf Baru">
            <Head title="Tambah Guru & Staf — Admin Portal" />
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500">
                                Isi formulir berikut untuk menambahkan tenaga pendidik atau kependidikan.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-6">
                            ...
                            <div className="space-y-2 flex-1 w-full">
                                <label className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-brand-50 border border-brand-200 text-brand-700 font-bold text-xs hover:bg-brand-100 transition-colors cursor-pointer shadow-2xs">
                                    ...
                                    <span>Pilih File Foto (JPG, PNG, WebP)</span>
                                    <input
                                        type="file"
                                ...
                                <p className="text-[11px] text-slate-500">
                                    Format: JPG, PNG, atau WebP. Maksimum ukuran file: 3MB. Disarankan foto portrait rasio 3:4 dengan latar belakang rapi.
                                </p>
